...
public class BaiduCloudUtil {
	...
	private static final Logger logger = LoggerFactory.getLogger(BaiduCloudUtil.class);
	...
	public static BaiduCloudInfo downloadAndGetFile(String url) {
		return downloadAndGetFile(url, null, null);
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	public static BaiduCloudInfo downloadAndGetFile(String url, String vcode_input, String vcode_str) {
		try {
			...
			return download(bdstoken, app_id, params, formParams);
		} catch (Exception e) {
	 ...
	 * @return
	 */
	public static BaiduCloudInfo download(String bdstoken, String app_id, Map params, Map formParams) {
		...
		if (resultInt == 0) {
			...
			if (StringUtils.isNotBlank(fileUrl)) {
				hasDownload = HttpUtil.download(fileUrl, SysConstants.FILE_PATH + fileName);
			}
	...
	public static class BaiduCloudInfo {
		...
		public BaiduCloudInfo(String fileName, String fileUrl, String bdstoken, String app_id, boolean hasDownload,
			...
			if (!hasDownload && StringUtils.isBlank(fileUrl)) {
